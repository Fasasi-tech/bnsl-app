...
const blurs='data:image/jpeg;base64,'
  return (
    <>
        <div className='w-full py-16 px-40  bg-white  dark:bg-slate-800 shadow-lg rounded-lg   mx-auto'>
            <div className='grid grid-cols-2 gap-4'>
                ...
                <div className=''>
                    <div className='border  border-t-0 border-x-0 pb-8 border-b border-dashed border-gray-500'>
                        <p className='text-3xl font-semibold font-mono'>{result.name}</p>
        ...
        <div className='w-full py-2 px-40 bg-white dark:bg-slate-800 shadow-lg rounded-lg mx-auto mt-8'>
            ...
            <div className='mt-4'>
                ...
                {active ==='reviews' && <ReviewsPage reviews={result.review}/>}
