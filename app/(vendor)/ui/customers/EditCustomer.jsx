...
import { useEditCustomerMutation } from '@/app/ui/utils/slices/usersApiSlice';
import { ToastContainer, toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
import LoaderBtn from '@/app/ui/utils/LoaderBtn';

const EditCustomer = ({data, isEditing}) => {
    ...
    const handleSubmit= async (values, {setSubmitting, resetForm}) =>{
        ...
        try{
            const updatedValues = {...values, id:data._id}
            await EditCustomer(updatedValues).unwrap()
            setSubmitting(false)
